...
ALTER TABLE `ims_ewei_shop_virtual_type` ADD COLUMN `linktext` int(11) NOT NULL DEFAULT '0';

ALTER TABLE `ims_ewei_shop_virtual_type` ADD COLUMN `linkurl` varchar(255) NOT NULL DEFAULT '0';
