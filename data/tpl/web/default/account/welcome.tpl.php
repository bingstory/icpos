...
<div class="home">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($copyright['footerright'])) { ?><a href="http://www.we7.cc">关于微信</a>&nbsp;&nbsp;<a href="http://www.we7.cc">微信社区</a>&nbsp;&nbsp;<a href="tencent://message/?uin=1582077961&Site=联系客服&Menu=yes">联系客服</a><?php  } else { ?><?php  echo $copyright['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($copyright['statcode'])) { ?><?php  echo $copyright['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($copyright['footerleft'])) { ?>Powered by <a href="http://www.we7.cc"><b>微信</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a><?php  } else { ?><?php  echo $copyright['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
